                  ...
                  {name === "github"
                    ...
                    : name === "linkedin"
                      ...
                      : name === "devpost"
                        ? "@AnamGTR99"
                        : "@sheivault"}{" "}
                  <svg width="10" height="10" viewBox="0 0 12 12" fill="none" stroke="currentColor" strokeWidth="1.5" style={{display:"inline",verticalAlign:"middle",marginLeft:"2px"}}><path d="M3 9L9 3M9 3H4.5M9 3V7.5"/></svg>
                </span>
              </a>
            ))}
          </div>
